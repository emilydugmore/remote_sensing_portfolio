...
We could also choose to only deal with the pixels of overlapping tiles, either applying a **mosaic**, or by taking the **mean** value of the overlapping pixels across the whole image collection.
